...
export const OLD_PROJECTS_DATA: PROJECT_CARD_DATA_PROPS[] = [
  ...
  },
  {
    ...
    department: PROJECTS_DEPARTMENT.CREATIVE,
    description:
      "They have taught the world to print, and scan. There's no one better than them, who has engineered this art to supreme sublimity. HP needed to decode a design for the digital campaigning of their product HP Page Wide Pro 577dw MFP. We sat with them on the meeting table and astonished them with our creative imprint. With our digital strategy, we manufactured a smart and productive digital campaign based on the products revolutionary features that had the potential to redefine the market.",
  },
  {
    slug: "ornet",
    img: ornet_logo,
  ...
  },
  {
    ...
    department: PROJECTS_DEPARTMENT.CREATIVE,
    description:
      "The BellaCasa Fashion and Retail Ltd, the bedsheet brand in its remodeling phase met us with a competitor in mind and with our artistry they have soared above and beyond their competitor in terms of their recent work. From our first creative photo shoot for their product catalog, we completely changed their outline and set the tone towards more premium and glamorous outlook.With our artistic wand, we did create a midnight Snow White out of Bellacasa. The aftereffect was both tantalizing and dazzling. It made everyone desire for more.The desire for more effect took the shape of the sizzling storm, and suddenly the bling-bang happened when the mesmerizing Jacqueline agreed to get wrapped in Bellacasa style.We orchestrated very sophisticated and elegant photo shoot, which enhanced the magical aura of Jaqueline.",
  },
  {
    slug: "mytreks-ai",
    img: mytreks,
